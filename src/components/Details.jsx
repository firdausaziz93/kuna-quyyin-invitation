...
function Details() {
    ...
    { 
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h.01M15 12h.01" />
        </svg>
      )
    },
    { 
  ...
  const FloralOrnament = ({ className }) => (
    <svg className={className} viewBox="0 0 80 80" fill="currentColor">
      ...
      <ellipse cx="40" cy="40" rx="6" ry="12" transform="rotate(45 40 40)" opacity="0.6" />
      <ellipse cx="40" cy="40" rx="12" ry="6" transform="rotate(45 40 40)" opacity="0.6" />
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16 relative">
          <div className="inline-block relative">
            ...
            <p className="text-sm font-medium tracking-[0.3em] text-blue-600 mb-3 uppercase" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Butiran
            </p>
          ...
          {eventDetails.map((detail) => (
            ...
            >
              <div className="bg-gradient-to-b from-white/95 to-blue-50/80 backdrop-blur-xl border border-blue-200/50 rounded-2xl p-6 md:p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                ...
                <p className="text-xs font-medium tracking-[0.25em] text-blue-600 mb-3 uppercase" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  {detail.label}
                </p>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <p className="text-sm font-medium tracking-[0.2em] text-blue-600 uppercase" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Lokasi Majlis
            </p>
            <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
          ...
          <div className="aspect-video w-full relative overflow-hidden rounded-xl border border-blue-100">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7964.047051019234!2d102.77219439119757!3d3.5820706355683187!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31ced5c326cd2cb9%3A0xb360a310a1d94ce9!2sDewan%20Jubli%20Perak%20Sultan%20Haji%20Ahmad%20Shah%20Maran!5e0!3m2!1sen!2smy!4v1769405746302!5m2!1sen!2smy"
              width="100%"
              height="100%"
              style={{ border: 0, filter: 'grayscale(0.1) contrast(1.05) brightness(1.0)' }}
              allowFullScreen=""
              loading="lazy"
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          <motion.a
            href="https://maps.app.goo.gl/SKN2Ct2H6Egkh7hJ6"
            target="_blank"
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div className="w-2 h-2 rounded-full bg-blue-400" />
            <p className="text-sm font-medium tracking-[0.25em] text-blue-600 uppercase" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Atur Cara Majlis
            </p>
            <div className="w-2 h-2 rounded-full bg-blue-400" />
              ...
              >
                <div className="flex items-center gap-4 py-4 group">
                  ...
                  <div className="flex-1 flex justify-between items-center bg-white/60 rounded-xl px-4 py-3 border border-blue-100/50 group-hover:bg-white/80 transition-colors duration-300">
                    <span className="font-dm text-gray-700 text-sm">{item.event}</span>
                    <span className="font-playfair text-blue-700 text-sm font-medium">{item.time}</span>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <motion.div
          variants={itemVariants}
          className="relative bg-gradient-to-b from-white/95 to-blue-50/80 backdrop-blur-xl border border-blue-200/50 rounded-2xl p-6 md:p-8 mt-8 text-center shadow-lg overflow-hidden"
        >
          {/* Inner decorative border */}
          <div className="absolute inset-3 border border-blue-200/30 rounded-xl pointer-events-none" />
          ...
          <p className="font-playfair text-2xl text-gray-800 mb-4">Formal / Semi-Formal</p>
          
          {/* Color swatches */}
          <div className="flex items-center justify-center gap-4 mt-6">
            <div className="group flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-blue-400 shadow-lg ring-4 ring-blue-100 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-xs text-gray-500 mt-2">Blue</span>
            </div>
            <div className="group flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-blue-200 shadow-lg ring-4 ring-blue-50 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-xs text-gray-500 mt-2">Light Blue</span>
            </div>
            <div className="group flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-white shadow-lg ring-4 ring-gray-100 border border-gray-200 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-xs text-gray-500 mt-2">White</span>
            </div>
            <div className="group flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-gray-100 shadow-lg ring-4 ring-gray-50 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-xs text-gray-500 mt-2">Off-white</span>
            </div>
          </div>
        </motion.div>
      </motion.div>
