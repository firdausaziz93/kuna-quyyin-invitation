    ...
    <section className="min-h-screen flex flex-col px-4 py-12">
      ...
      >
        <div className="relative px-4 py-2">
          {/* Main glassy content */}
          <div className="bg-gradient-to-b from-white/95 to-blue-50/90 backdrop-blur-xl border border-blue-300/50 shadow-xl py-5 px-8 text-center rounded-xl relative overflow-visible">
            {/* Left Floral Ornament - top left corner overlay */}
            <svg
              className="absolute -top-5 -left-5 w-14 h-14 text-blue-600 z-10"
              viewBox="0 0 80 80"
              fill="currentColor"
            >
              {/* Main flower */}
            ...
            {/* Right Floral Ornament - top right corner overlay */}
            <svg
              className="absolute -top-5 -right-5 w-14 h-14 text-blue-600 scale-x-[-1] z-10"
              viewBox="0 0 80 80"
              fill="currentColor"
            >
              {/* Main flower */}
            ...
            <div className="absolute -top-px left-12 right-12 flex items-center justify-center gap-2">
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-400 to-blue-500" />
              <div className="w-2 h-2 rounded-full bg-blue-500 -translate-y-0.5" />
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400 -translate-y-0.5" />
              <div className="w-2 h-2 rounded-full bg-blue-500 -translate-y-0.5" />
              <div className="flex-1 h-px bg-gradient-to-l from-transparent via-blue-400 to-blue-500" />
            </div>

            {/* Bottom decorative line with dots */}
            <div className="absolute -bottom-px left-12 right-12 flex items-center justify-center gap-2">
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-400 to-blue-500" />
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400 translate-y-0.5" />
              <div className="w-2 h-2 rounded-full bg-blue-500 translate-y-0.5" />
              <div className="w-1.5 h-1.5 rounded-full bg-blue-400 translate-y-0.5" />
            ...
            {/* <p
              className="text-sm md:text-base font-medium tracking-[0.35em] text-gray-700 mb-2 uppercase"
            ...
            <motion.p
              ...
              className="font-playfair text-xl md:text-2xl text-gray-700 mb-2 leading-relaxed"
              style={{ direction: "rtl" }}
            >
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="font-playfair text-m md:text-2xl text-gray-700 mb-2 leading-relaxed mt-8"
            style={{ direction: "rtl" }}
          >
          ...
          <motion.p
            variants={itemVariants}
            className="font-playfair text-xl md:text-2xl text-gray-700 mb-6 leading-relaxed mt-4"
            style={{ direction: "rtl" }}
          >
          ...
          >
            Dengan penuh kesyukuran menjemput Dato'/Datin/Tuan/Puan/Encik/Cik ke
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 mb-10">
            ...
            <motion.div variants={itemVariants} className="flex items-center">
              ...
              <span className="font-playfair text-gray-400 text-xl mx-3 italic">
                &
              </span>
              <div className="w-8 h-px bg-gray-300" />
            </motion.div>
